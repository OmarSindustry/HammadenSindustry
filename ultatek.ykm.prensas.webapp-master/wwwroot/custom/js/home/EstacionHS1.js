...
var stamping_actual_element = document.getElementById('produccion_actual');
var stamping_actual_options = {
...
var stamping_actual = echarts.init(stamping_actual_element);
...
function getStamping_actual() {

    $.ajax({

        type: "GET",
        url: "/Home/Get_actual_stamping_Json",
        ...
        success: function (response) {
            if (response != null) {
                ...
                for (var i = 0, l = part_number.length; i < l; i++) {
                    ...
                    var data = [];
                    stamping_actual_options.series[i].name = a[i].part_number
                    ...
                    for (var k = 0, m = fecha.length; k < m; k++) {
                        ...
                        stamping_actual_options.series[i].data = data;
                ...
                for (var k = 0, m = stamping_actual_options.series.length; k < m; k++) {
                    if (stamping_actual_options.series[k].data.length != 0) {

                        for (var i = 0, n = stamping_actual_options.series.length; i < n; i++) {
                            if (stamping_actual_options.series[k].data[i] !== undefined) {

                                totales[i] = totales[i] + + stamping_actual_options.series[k].data[i];
                            }
                        }
                ...
                $.ajax({
                    ...
                    type: "GET",
                    url: "/Home/Get_proyectado_stamping_Json",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        if (response != null) {
                ...
                stamping_actual_options.series[36].data = [
                ...
                stamping_actual_options.series[37].data = [
                    proyectado_pasado,
                    proyectado_pasado * 2,
                    proyectado_pasado * 3,
                    proyectado_pasado * 4,
                ...
                stamping_actual_options.series[38].data = totales;


                stamping_actual_options.xAxis[0].data = fecha;
                stamping_actual_options.legend.data = part_numbers;
                stamping_actual.setOption(stamping_actual_options, true);
...
function get_jph() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: "/Home/Get_jph_stamping_Json",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            if (response != null) {
...
function get_grafica() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: "/Dashboard/Dashboard_Grafica_stamping_Json",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            if (response != null) {
